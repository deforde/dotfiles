...
theme.load_syntax = function()
    ...
    local syntax = {
        ...
        TSParameter = { c.vscFront, nil, 'none', nil },
        TSParameterReference = { c.vscFront, nil, 'none', nil },
        ...
        TSLabel = { c.vscFront, nil, 'none', nil },
        ...
        TSVariableBuiltin = { c.vscFront, nil, 'none', nil },
